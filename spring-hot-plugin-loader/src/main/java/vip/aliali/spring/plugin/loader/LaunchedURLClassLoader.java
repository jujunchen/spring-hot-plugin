...
package vip.aliali.spring.plugin.loader;

import vip.aliali.spring.plugin.loader.archive.Archive;
import vip.aliali.spring.plugin.loader.jar.Handler;
import vip.aliali.spring.plugin.loader.jar.JarFileWrapper;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
		if (name.startsWith("csdn.itsaysay.plugin.loader.jarmode.")) {
			try {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof vip.aliali.spring.plugin.loader.jar.JarFile) {
			((vip.aliali.spring.plugin.loader.jar.JarFile) jarFile).clearCache();
		}
	}
