...
import vip.aliali.spring.plugin.loader.data.RandomAccessData;
import vip.aliali.spring.plugin.loader.data.RandomAccessDataFile;
...
public class JarFile extends AbstractJarFile implements Iterable<java.util.jar.JarEntry> {
	...
	private static final String HANDLERS_PACKAGE = "csdn.itsaysay.plugin.loader";
