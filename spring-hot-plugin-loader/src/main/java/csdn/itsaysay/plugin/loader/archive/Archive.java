...
package csdn.itsaysay.plugin.loader.archive;


import csdn.itsaysay.plugin.loader.Launcher;
...
public interface Archive extends Iterable<Archive.Entry>, AutoCloseable {
	 ...
	 * {@link csdn.itsaysay.plugin.loader.jar.JarFile} to access entries and
